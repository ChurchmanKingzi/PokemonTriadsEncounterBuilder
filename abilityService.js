...
function getAbilityDescription(Name){
  switch(Name){
    ...
    case "Angsthase":
        return "Immer, wenn das Pokemon Schaden nimmt, wird seine Reaktion zurückerstattet. Diese Reaktion kann nur zum Ausweichen genutzt werden.";
    ...
    case "Sandsturm":
        return "Der Körper des Pokemon stößt passiv Sand aus. Ist es eine Stunde lang draußen, entsteht um es herum ein großer Sandsturm, der sich mit ihm mitbewegt.";
